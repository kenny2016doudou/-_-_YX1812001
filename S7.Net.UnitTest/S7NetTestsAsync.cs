...
namespace S7.Net.UnitTest
{
    public partial class S7NetTests
    {
        ...
        public async Task Test_Async_WriteAndReadRealVariables()
        {
            ...
            await plc.WriteAsync("DB1.DBD40", Conversion.ConvertToUInt(val));
            
            double result = ((uint)await plc.ReadAsync("DB1.DBD40")).ConvertToFloat();
        ...
        public async Task Test_Async_ReadWriteDouble()
        {
            ...
            double test_value2 = Conversion.ConvertToFloat((uint)helper);
