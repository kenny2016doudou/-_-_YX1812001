...
{
    public partial class yxShowText : UserControl
    {
        ...
        private Font descfont = new Font(SystemFonts.CaptionFont.FontFamily, 12, FontStyle.Bold);
        ...
        {
            ttsize = TextRenderer.MeasureText(e.Graphics, smStr, descfont);
            if (fillIndex == 1)
            {
                e.Graphics.DrawString(smStr, descfont, Brushes.Black, (this.Width - ttsize.Width) / 2, (this.Height - ttsize.Height - textBox1.Height) / 2);
            }
            else if (fillIndex == 3)
            {
                e.Graphics.DrawString(smStr, descfont, Brushes.Black, (this.Width - ttsize.Width) / 2, (this.Height - ttsize.Height + textBox1.Height) / 2);
