...
{
    public class ReadPV_YuDianYB:IRead
    {
        private string addr;
        ...
        public ReadPV_YuDianYB() { }

        public ReadPV_YuDianYB(string addr, string parm_addr)
        {
            this.addr = addr;
            this.parm_addr = parm_addr;
        }

        public ReadPV_YuDianYB(string addr, string parm_addr, int sleep)
        {
            this.addr = addr;
            this.parm_addr = parm_addr;
            this.sleep = sleep;
        ...
        public ReadPV_YuDianYB(string addrs)
        {
        ...
        /// </summary>
        /// <param name="addrs"></param>
        public ReadPV_YuDianYB(string addrs, int sleep)
        {
            string[] str = addrs.Split('#');
            this.addr = str[0];
            this.parm_addr = str[1];
        ...
        public object Data
        {
            ...
            {
              //返回PV值
              return  YBYudianControl.getInstance().ReadPV(datas, addr);
            }
        }
